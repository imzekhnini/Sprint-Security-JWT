...
public class SsJwtApplication {
  ...
  //
  // accountService.addNewAppUser(new AppUser(null, "teacher1", "1234", new
  // ArrayList<>()));
  // accountService.addNewAppUser(new AppUser(null, "teacher2", "1234", new
  // ArrayList<>()));
  // accountService.addNewAppUser(new AppUser(null, "student1", "1234", new
  // ArrayList<>()));
  // accountService.addNewAppUser(new AppUser(null, "student2", "1234", new
  // ArrayList<>()));
  // accountService.addNewAppUser(new AppUser(null, "admin", "1234", new
  // ArrayList<>()));
  //
